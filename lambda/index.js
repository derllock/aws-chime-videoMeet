...
const chime = new AWS.Chime({ region: "ap-southeast-2" });
...
//Replace region as needed. Using 'ap-southeast-2' in this example.
chime.endpoint = new AWS.Endpoint("https://meetings-chime.ap-southeast-2.amazonaws.com");
...
async function doMeeting(event) {
    ...
    if ((meetingId === "") || (meetingId === null) || (meetingId === "null")) {
        ...
        meeting = await chime
            ...
            .promise().catch((err) => {
                console.log("ERROR while creating meeting " + JSON.stringify(err));
